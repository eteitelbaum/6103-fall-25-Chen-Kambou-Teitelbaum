...
Top-left visualization on the dashboard page.
...
def create_viz_1(df_filtered, selected_indicator=None):
    """
    Create the first visualization (placeholder).
    This will be displayed in the top-left position on the dashboard.
    ...
    fig.add_annotation(
        text=f"Visualization 1 - To be implemented\nSelected indicator: {indicator_label}",
    ...
    fig.update_layout(
        title=f"Visualization 1: {indicator_label}",
